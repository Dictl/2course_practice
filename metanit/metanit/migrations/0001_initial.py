    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_to_store', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'component',
                'managed': False,
        ...
        migrations.CreateModel(
            name='CPU',
            fields=[
                ('component', models.OneToOneField(db_column='component_id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='metanit.component')),
                ...
                ('integrated_graphics', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
                'db_table': 'cpu',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pci_e_ver_exp', models.CharField(blank=True, max_length=10, null=True)),
